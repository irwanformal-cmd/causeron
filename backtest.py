#!/usr/bin/env python3
"""Backtest Causeron's predictions against historical scenarios with known outcomes.
...
def main() -> int:
    ...
    print(f"\nCauseron backtest — {len(rows)} historical scenario(s), offline rule-based mode\n")
