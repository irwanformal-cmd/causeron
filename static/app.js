/* Causeron · causal prediction engine, frontend logic. */
...
const I18N = {
  en: {
    ...
    buildHint: "Paste a scenario, a decision, or a “what if” question. Causeron maps out the web of consequences · what this causes, and what those cause next.",
    ...
    explainHint: "Pick an event to discuss it with Causeron · it can grow the web around it, and you can edit any node.",
    chatPlaceholder: "Ask about this event, or propose a “what if”…",
    send: "Send", you: "You", aiDev: "Causeron", rename: "Rename", delete: "Delete",
    ...
    donate: "Donate",
    llmSettings: "LLM provider settings", llmSettingsHint: "Connect Causeron to any OpenAI-compatible provider · DeepSeek, OpenAI, Qwen, Ollama, or a custom endpoint. Leave empty to stay in offline (rule-based) mode.", llmTest: "Test connection", llmSave: "Save", llmTestOk: "Connection OK", llmTestFail: "Connection failed", llmSaved: "Saved · provider configured",
    undo: "Undo", redo: "Redo",
    goalTitle: "How can this happen?", goalHint: "Name a desired outcome — Causeron reasons backward from it and proposes prerequisite paths. Proposals are hypotheses, not predictions; nothing joins the network unless you add it.", goalPlaceholder: "e.g. Air pollution decreases by 40%", goalFind: "Find a path", goalLegTarget: "target (your goal)", goalLegReq: "generated requirement", goalLegProp: "proposed link",
  ...
  id: {
    ...
    buildHint: "Tempel skenario, keputusan, atau pertanyaan “bagaimana jika”. Causeron memetakan jaring konsekuensinya · apa yang ditimbulkannya, dan apa yang ditimbulkan setelahnya.",
    ...
    explainHint: "Pilih sebuah peristiwa untuk mendiskusikannya dengan Causeron · ia bisa mengembangkan jaring di sekitarnya, dan kamu bisa mengedit node apa pun.",
    chatPlaceholder: "Tanyakan tentang peristiwa ini, atau ajukan “bagaimana jika”…",
    send: "Kirim", you: "Kamu", aiDev: "Causeron", rename: "Ganti nama", delete: "Hapus",
  ...
  zh: {
    ...
    buildTitle: "描述场景",
    buildHint: "粘贴场景、决策或“如果”问题。Causeron 会绘制出后果网络。",
    seedPh: "在此粘贴场景…",
    ...
    explainHint: "选择事件与 Causeron 讨论·它可以在其周围扩展网络，你也可以编辑任意节点。",
    chatPlaceholder: "询问此事件，或提出“如果”……",
    send: "发送", you: "你", aiDev: "Causeron", rename: "重命名", delete: "删除",
    ...
    donate: "支持",
    llmSettings: "LLM 提供商设置", llmSettingsHint: "将 Causeron 连接到任何 OpenAI 兼容提供商。留空则保持离线（基于规则）模式。", llmTest: "测试连接", llmSave: "保存", llmTestOk: "连接成功", llmTestFail: "连接失败", llmSaved: "已保存",
    undo: "撤销", redo: "重做",
    goalTitle: "如何实现这一目标？", goalHint: "输入期望的结果 — Causeron 会从目标反向推理，提出前提路径。这些只是假设而非预测；只有您确认添加后才会并入网络。", goalPlaceholder: "例如：空气污染下降 40%", goalFind: "查找路径", goalLegTarget: "目标（您的期望）", goalLegReq: "生成的先决条件", goalLegProp: "提议的连接",
...
/* ------------------------------------------------------------------ theme */
const THEME_KEY = "causeron_theme";
